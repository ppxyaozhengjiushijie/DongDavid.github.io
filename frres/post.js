$(document).ready(function(){
    ...
    window.disqus_shortname = 'dongdavid'; // required: replace example with your forum shortname
   /* $('#disqus_container .comment').on('click',function(){
    ...
    $.getScript('/frres/prettify/prettify.js',function(){
        prettyPrint();
    });
    ...
    if(/css3-animation/.test(location.href)){
        $("head").append("<link rel='stylesheet' type='text/css' href='/frres/css3-ani.css'/>");
        $.getScript('/frres/css3-ani.js',function(){});
    }
});
